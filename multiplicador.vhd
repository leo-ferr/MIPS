...
ARCHITECTURE behavior OF multiplicador IS
	...
	SIGNAL op_2_9_bits : STD_LOGIC_VECTOR(tamanho + 1 DOWNTO 0);
	
	SIGNAL saida_gera_operando1, saida_gera_operando2: STD_LOGIC_VECTOR(tamanho + 1 DOWNTO 0);
	SIGNAL saida_gera_operando3, saida_gera_operando4: STD_LOGIC_VECTOR(tamanho + 1 DOWNTO 0);
	
	SIGNAL saida_soma_1, saida_soma_2, saida_soma_3: STD_LOGIC_VECTOR(tamanho + 1 DOWNTO 0);
	SIGNAL cout1 : STD_LOGIC;
	
	SIGNAL aux1, aux2, aux3 : STD_LOGIC_VECTOR(tamanho + 1 DOWNTO 0);
BEGIN
